    ...
    <div className='background'>
      <div className='loginContainer'>
        ...
        <form method='post' onSubmit={handleSubmit} className='loginForm'>
          <input className='textInput' name="username" placeholder="admin" disabled={true} defaultValue={"admin"}></input>
          <input className='textInput' name="password" type="password" placeholder='Password' onChange={text => setPassword(text)}/>
